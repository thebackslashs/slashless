...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::info!("  Redis URL: redis://{}:{}", config.redis_host, config.redis_port);
    ...
    tracing::info!("Redis connection pool initialized with {} max connections", config.max_connections);
